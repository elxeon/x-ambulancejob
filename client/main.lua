...
CreateThread(function()
  for k, v in pairs(Config.Hospitals) do
    ...
    AddTextComponentSubstringPlayerName('Ziekenhuis')
  ...
  while true do
    ...
    if isDead then
      ...
      EnableControlAction(0, 56, true) -- f9
...
Citizen.CreateThread(function()
  while true do
      ...
      if isDead then
        ...
        AddTextComponentSubstringPlayerName('Druk op [F9] Als de ambulance je niet ziet')
        EndTextCommandDisplayText(0.4, 0.77)

        if IsControlJustReleased(0, 56) and GetLastInputMethod(2) then
...
AddEventHandler('esx_ambulancejob:useItem', function(itemName)
  ...
  if itemName == 'bandage' then
    ...
    ESX.Streaming.RequestAnimDict(lib, function()
      ...
      exports['qs-core']:Notify("Je hebt 1 verband gebruikt", "success")
    end)
  end
end)
...
function StartDistressSignal()
  CreateThread(function()
    ...
    while timer > 0 and isDead do
      ...
      EndTextCommandDisplayText(0.4, 0.74)
